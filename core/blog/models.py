...
class Post(models.Model):
    ...
    author = models.ForeignKey(
        CustomUser, on_delete=models.CASCADE, verbose_name="نویسنده"
    )
    ...
    published_at = models.DateTimeField(
        default=timezone.now, verbose_name="منتشر شده در"
    )
...
class Comment(models.Model):
    post = models.ForeignKey(
        Post, on_delete=models.CASCADE, related_name="comments", verbose_name="مقاله"
    )
